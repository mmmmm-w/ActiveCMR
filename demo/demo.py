...
from active_cmr.policy import HybridPolicy, SequentialPolicy, SampleVariancePolicy
...
checkpoint_path = "./demo/cvae_z128_beta0.001.pth"
...
# policy = SequentialPolicy(volume_size=ground_truth_volume.shape, scan_budget=scan_budget)
policy = SampleVariancePolicy(volume_size=ground_truth_volume.shape, scan_budget=scan_budget)
...
imageio.mimsave('./demo/segmentation_progress.gif', gif_frames, fps=1) # Adjust fps as needed